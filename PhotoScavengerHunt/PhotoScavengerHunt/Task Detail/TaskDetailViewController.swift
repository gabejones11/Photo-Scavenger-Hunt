...
class TaskDetailViewController: UIViewController {
    ...
    let attachPhotoButton: UIButton = {
        let button = UIButton()
        button.addTarget(self, action: #selector(attachPhotoButtonClicked), for: .touchUpInside)
    ...
    func setupUI(){
        ...
        NSLayoutConstraint.activate([
            ...
            completedImageView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 10),
            completedImageView.topAnchor.constraint(equalTo: view.topAnchor, constant: 120),
            
            completedLabel.leadingAnchor.constraint(equalTo: completedImageView.leadingAnchor, constant: 25),
            completedLabel.topAnchor.constraint(equalTo: completedImageView.topAnchor),
            
            descriptionLabel.topAnchor.constraint(equalTo: completedImageView.bottomAnchor, constant: 20),
            descriptionLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -10),
            descriptionLabel.leadingAnchor.constraint(equalTo: completedImageView.leadingAnchor),
            ...
            attachPhotoButton.topAnchor.constraint(equalTo: mapView.bottomAnchor, constant: 10),
            attachPhotoButton.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 10),
            attachPhotoButton.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -10)
    ...
    @objc private func attachPhotoButtonClicked() {
